...
const Chart1: React.StatelessComponent<IChart1Props> = props => {
  ...
  const completedPercent = (performanceSkillsByEmployee.length * 100) / usersCount;
  ...
  Chart.helpers.extend(Chart.controllers.doughnut.prototype, {
    draw() {
      ...
      const fontFamily = "Segoe UI WestEuropean,Segoe UI,-apple-system,BlinkMacSystemFont,Roboto,Helvetica Neue,sans-serif";
