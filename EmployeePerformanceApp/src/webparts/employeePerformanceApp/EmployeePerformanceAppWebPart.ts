...
import { IEmployeePerformanceAppWebPartProps } from './IEmployeePerformanceAppWebPartProps';
import { MockDataProvider } from './dataProviders';
import IDataProvider from './dataProviders/IDataProvider';
import Main, { IMainProps } from './components/Main';

export default class EmployeePerformanceAppWebPart extends BaseClientSideWebPart<IEmployeePerformanceAppWebPartProps> {
